            ...
            <div class="col-md-12">
              ...
              <div class="card flex">
                ...
                <div class="row justify-content-center">
                    <div  class="card-body">
                        <div>
                        <form class="form-horizontal" method="POST" action="{{ route('dept_programs_import_parse') }}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    <div class="checkbox">
                                        <p>Download Sample document to get School name and ID</p>
                                    </div>
                                </div>
                                <!-- /.row -->
                            </div>
