...
<section class="content m-10">
    <div class="flex" style="margin-bottom:-30px; margin-top:-10px">
        <a href="{{url('schools')}}" class="btn-sm btn-kabarak btn"><span class="fas fa-arrow-left"></span>&nbsp;Back to
            list of Schools </a>&nbsp;
        <a class="btn btn-kabarak btn-sm" data-toggle="modal" data-target="#newProgramModal"><span
                class="fas fa-plus"></span>&nbsp; Add new lecturer </a>
        {{-- <a class="btn btn-kabarak btn-sm float-right" href="{{url('programs_imports')}}"> <i
                class="fas fa-pencil-alt"> </i> &nbsp; Upload lecturer </a> --}}
    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="name" class="form-control" name="first_name"
                                        placeholder="eg. Andrew" required>
                                </div>
                                <div class="form-group">
                                    <label for="program-name">Lecturer last Name</label>
                                    <input type="text" id="name" class="form-control" name="last_name"
                                        placeholder="e.g Kebut" required>
                                </div>

                                <div class="form-group">
                                    <label for="program-name">Lecturer Email</label>
                                    <input type="text" id="name" class="form-control" name="lec_email"
                                        placeholder="e.g andrew@gmail.com" required>
                                </div>

                                <div class="form-group">
                                    <label for="program-name">Password</label>
                                    <input type="text" id="name" class="form-control" name="password"
                                        placeholder="e.g andrew123" required>
                                </div>

                                <div class="form-group">
                                    <label for="school">Department</label>

                                    <select name="department" id="school" class="form-control"
