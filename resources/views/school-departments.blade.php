      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" method="POST" action="{{url('add_school_department')}}">
              {{csrf_field()}}
              <div class="card-body">
                <div class="form-group">
                  <input name="school_department" type="hidden" value="{{$school->id}}">
                  {{-- <input name="school_department" type="hidden" class="form-control" value="{{$school->id}}" required> --}}
            ...
            @if($department->school_ID == $school->id)
              <tr>
                ...
                <td class="project-actions text-left float-right">
                  ...
                  <a class="btn btn-info btn-sm" href="{{url('edit-school-department/'.$department->id)}}">
                    <i class="fas fa-pencil-alt">
                    </i>
                    Edit
                  </a>
