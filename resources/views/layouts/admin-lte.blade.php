...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{asset('dist/img/kabu-logo.jpeg')}}" alt="KABULogo" height="60"
                width="60">
        </div>
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    ...
                    {{-- <button class="btn btn-primary" data-widget="pushmenu" data-auto-collapse-size="768">Toggle
                        Sidebar</button>--}}
                </li>
        ...
        <aside class="p-3 mb-2 bg-danger text-white main-sidebar sidebar-dark-primary elevation-4"
        ...
        <div class="content-wrapper">
            ...
            <footer class="main-footer fixed-bottom">
                <strong>Copyright &copy; 2021 <a href="https://kabarak.ac.ke">Kabarak University</a>.</strong> All
                rights reserved.
