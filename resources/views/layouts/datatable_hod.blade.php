        ...
        <div class="wrapper">
            ...
            <aside class="p-3 mb-2 bg-danger text-white main-sidebar sidebar-dark-primary elevation-4" style="text-color:white">
               ...
               with font-awesome or any other icon font library -->
                            ...
                            <li class="nav-item">
                                <a href="{{url("hods/dept_programs/".session('hods'))}}" class="nav-link {{ (request()->is('programs')) || (request()->is('viewupdateProgram/*')) ? 'active' : '' }}">
                                    <i class="fas fa-graduation-cap"></i>&nbsp;
                                    <p>Programs</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url("hods/dept_units/".session('hods'))}}" class="nav-link {{ (request()->is('units')) || (request()->is('viewupdateUnit/*')) ? 'active' : '' }}">
                                    <i class="fas fa-book"></i>&nbsp; &nbsp;
                                    <p>Units</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url("hods/dept_lecturers/".session('hods'))}}" class="nav-link {{ (request()->is('lecturers')) ? 'active' : '' }}">
                                    <i class="fas fa-users"></i>&nbsp;&nbsp;&nbsp;
                                    <p>Lecturers</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{url("hods/dept_programs_levels/".session('hods'))}}" class="nav-link {{ (request()->is('cohorts')) ? 'active' : '' }}">
                                    <i class="fas fa-users"></i>&nbsp;
                                    <p>Cohorts</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="{{url("hods/hodtimetable/".Auth::user()->email)}}" class="nav-link {{ (request()->is('units')) || (request()->is('viewupdateUnit/*')) ? 'active' : '' }}">
